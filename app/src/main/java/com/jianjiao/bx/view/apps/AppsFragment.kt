...
import com.jianjiao.bx.databinding.FragmentAppsBinding
import com.jianjiao.bx.util.InjectionUtil
import com.jianjiao.bx.util.ShortcutUtil
...
import com.jianjiao.bx.view.main.MainActivity
...
class AppsFragment : Fragment() {
    ...
    private lateinit var mAdapter: RVAdapter<com.jianjiao.bx.bean.AppInfo>
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        mAdapter = RVAdapter<com.jianjiao.bx.bean.AppInfo>(requireContext(), AppsAdapter())
    ...
    private fun unInstallApk(info: com.jianjiao.bx.bean.AppInfo) {
     ...
     * @param info AppInfo
     */
    private fun stopApk(info: com.jianjiao.bx.bean.AppInfo) {
        MaterialDialog(requireContext()).show {
     ...
     * @param info AppInfo
     */
    private fun clearApk(info: com.jianjiao.bx.bean.AppInfo) {
        MaterialDialog(requireContext()).show {
