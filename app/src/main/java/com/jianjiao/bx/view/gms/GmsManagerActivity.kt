...
import com.jianjiao.bx.databinding.ActivityGmsBinding
...
class GmsManagerActivity : LoadingActivity() {
    ...
    private lateinit var mAdapter: RVAdapter<com.jianjiao.bx.bean.GmsBean>
    ...
    private fun initRecyclerView() {
        mAdapter = RVAdapter<com.jianjiao.bx.bean.GmsBean>(this, GmsAdapter())
