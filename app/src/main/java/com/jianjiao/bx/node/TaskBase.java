...
import static com.jianjiao.bx.node.AccUtils.*;
...
import com.jianjiao.bx.node.findColor.ScreenLib;
import com.jianjiao.bx.node.ntptime.NtpService;
import com.jianjiao.bx.node.okhttp3.HttpUtils;
import com.jianjiao.bx.node.okhttp3.WebSocketUtils;
import com.jianjiao.bx.node.utils.ExceptionUtil;
import com.jianjiao.bx.node.utils.FileUtils;
import com.jianjiao.bx.node.utils.ScreenshotUtils;
...
public class TaskBase extends UiSelector implements ITaskBase {
    ...
    public void initJavet(String script) {
        try {
            v8Runtime = V8Host.getV8Instance().createV8Runtime();
            isRunning = true;
            isStop = false;
            killThread = false;
            //String script = "showLog();print('尖叫111')";
            //String str = "";//FileUtils.readFile("/sdcard/aaa.js");
            if (base == null) {
