...
import static com.jianjiao.bx.node.GlobalVariableHolder.tag;
...
public class FileUtils {
    ...
    public static File getApkFileFromAssets(String assetFileName) {
        ...
        try (InputStream in = context.getAssets().open(assetFileName);
            ...
            out.flush();
            Log.i(TAG, "APK file copied to: " + outputFile.getAbsolutePath());
        } catch (IOException e) {
