...
import static com.jianjiao.bx.node.AccUtils.moveFloatWindow;
import static com.jianjiao.bx.node.AccUtils.printLogMsg;
import static com.jianjiao.bx.node.GlobalVariableHolder.*;
...
public class FloatingButton extends Service {
    ...
    private void splitCircles(WindowManager.LayoutParams parameters) {
        ...
        smallParams1.gravity = Gravity.LEFT | Gravity.TOP;
        smallParams1.setTitle("T");
        ...
        smallParams2.gravity = Gravity.LEFT | Gravity.TOP;
        ...
        smallParams3.y = parameters.y + (2 * (btn_w * 6 / 5));
        smallParams3.gravity = Gravity.LEFT | Gravity.TOP;
        ...
        smallParams4.y = parameters.y + (3 * (btn_w * 6 / 5));
        smallParams4.gravity = Gravity.LEFT | Gravity.TOP;
        smallParams4.setTitle("F");
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        //加入自动吸附
                        if (updatedParameters.x > mWidth / 2) {
                            updatedParameters.x = mWidth - btn_w;
                        } else {
